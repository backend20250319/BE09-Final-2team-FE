...
export const productAPI = {
  ...
  getProductsSummary: (productIds) =>
      api.get(`/product-service/products/summary?productIds=${productIds.join(',')}`),
...
export const reviewAPI = {
  ...
  // 명예의 전당 (상위 3명 랭킹) 조회 (경로 수정)
  getHallOfFame: () => api.get('/review-service/reviews/top3'),
  // 사용자별 평균 별점 조회
