  ...
  return (
    <div className="product-detail-container">
          ...
          <div className="product-detail-info">
            <div className="product-detail-breadcrumb">
              {categoryPath.map((category, index) => (
                <React.Fragment key={category.id}>
                  ...
                  {index < categoryPath.length - 1 && <span className="product-detail-separator">{">"}</span>}
                </React.Fragment>
              ))}
            ...
            <div className="product-detail-details">
              <div className="product-detail-detail-item">
                ...
                <span>상품상태</span>
                <span className="product-detail-tag">{getProductStatusText(product.productStatus)}</span>
              </div>
                ...
                <div className="product-detail-location-tags">
                  {product?.tradeAreas?.map((area, index) => (
                    <div key={index} className="product-detail-location-tag">
                      <img src="/images/product/address-marker.svg" alt="위치" width={12} height={12} />
                      <span>{area}</span>
                    </div>
                  ))}
                </div>
              ...
              {isMyProduct ? (
                ...
                <div className="product-detail-trade-actions-container">
                  ...
                  <div className="product-detail-trade-action-item" style={{ position: "relative" }}>
                    ...
                    >
                      <img src="/images/product/update-status.svg" alt="상태변경" width={18} height={18} />
                      <span>상태변경</span>
                    </div>
                  ...
                  <span className="product-detail-trade-divider">|</span>
                  <div className="product-detail-trade-action-item">
                    <img src="/images/product/delete-product.svg" alt="삭제" width={18} height={18} />
                    <span>상품삭제</span>
                  </div>
                </div>
              ) : (
      ...
      <div className="product-detail-info-section">
        <div className={`product-detail-product-info-section ${isMyProduct ? "product-detail-full-width" : ""}`}>
          <div className="product-detail-section-header">
            <h2>상품 정보</h2>
          </div>
          <div
            ref={productInfoRef}
            className={`product-detail-section-content ${!isProductInfoExpanded ? "product-detail-collapsed" : ""}`}
            style={{
        ...
        <div className="product-detail-related-products">
          ...
          <div className="product-detail-related-navigation-arrows">
            <button
              ...
              onClick={() => handleSlide("prev", relatedSlideIndex, setRelatedSlideIndex, relatedProducts.length)}
            >
            ...
            <button
              ...
              onClick={() => handleSlide("next", relatedSlideIndex, setRelatedSlideIndex, relatedProducts.length)}
            >
