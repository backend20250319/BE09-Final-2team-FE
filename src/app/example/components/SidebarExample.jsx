              ...
              <Sidebar title="기본 사이드바" trigger={<Button variant="default">기본 사이드바 열기</Button>}>
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">
                    이 사이드바는 가장 기본적인 형태로, 트리거 버튼을 클릭하면 오른쪽에서 나타납니다. 다양한 상황에 맞게
                    커스터마이징할 수 있습니다.
                  </p>
                </div>
              </Sidebar>
            ...
            <div className="border-t pt-6">
              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">
                    이 예제는 titleClassName prop을 사용하여 제목의 스타일을 커스터마이징한 것입니다. Tailwind CSS
                    클래스를 조합하여 원하는 스타일을 만들 수 있습니다.
                  </p>
                </div>
              </Sidebar>
            </div>
              ...
              <Sidebar
                ...
                footer={
                  <div className="flex gap-2">
                    ...
                    <Button className="flex-1 bg-green-600 hover:bg-green-700">저장</Button>
                  </div>
                }
              >
                <div className="space-y-4">
              ...
              <Sidebar
                ...
                footer={
                  <div className="flex gap-2">
                    ...
                    <Button className="flex-1 bg-orange-600 hover:bg-orange-700">상품 등록</Button>
                  </div>
                }
              >
                <div className="space-y-4">
